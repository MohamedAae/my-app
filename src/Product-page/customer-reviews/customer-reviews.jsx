    ...
    return (
        <section className="w-11/12 mx-auto mt-5">
            ...
            {showModal ? (
                <>
                    <div
                        className="z-50 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg shadow-lg bg-white py-12 px-4 sm:px-6 lg:px-8">
                        <form onSubmit={(event) => submitData(event)}>
                            ...
                            <div
                                className="flex justify-between w-96 items-center my-5">
                                <label
                                    for="default-input"
                    ...
                    return (
                        <div className="w-10/12 mx-auto">
                            <section className="flex jusrify-center my-10">
                                ...
                                <div className="w-3/4">
                                    <div
                                        className="flex mt-2.5 mb-5">{forloop(review.rating)}</div>
