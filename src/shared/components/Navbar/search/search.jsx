        ...
        <form className="w-3/4">
            <div className="flex">
                ...
                <button id="dropdown-button" data-dropdown-toggle="dropdown"
                        ...
                        type="button">All <svg aria-hidden="true"
                ...
                <div className="relative w-full">
                    <input type="search" id="search-dropdown"
                           ...
                           required="" />
                        <button type="submit"
                                className="absolute top-0 right-0 p-2.5 text-sm font-medium text-white bg-blue-700 border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
