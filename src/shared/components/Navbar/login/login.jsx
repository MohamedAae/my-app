...
const Login = (props) => {
    ...
    const changeDataHandler = (event, init) => {
        ...
        switch (init) {
            ...
            case "rememberme":
                setUserCredentials({
                    ...userCredentials, rememberMe: !userCredentials.rememberMe,
                });
                break;
    ...
    return (<>
            <button
                className="py-2 text-gray-700 bg-theme hover:bg-theme-hover hoverable hover:text-gray-200  capitalize text-sm mx-2 px-2 rounded-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                type="button"
            ...
            {showModal ? (<>
                    <div
                        ...
                        <div className="max-w-md w-full">
                            ...
                            >
                                {errorMessage ? <span
                                    className={`m-0 flex justify-center items-center text-red-600 font-medium text-sm text-center w-full`}>{errorMessage}</span> : ""}
                                <input
                                    type="hidden"
                                    name="remember"
