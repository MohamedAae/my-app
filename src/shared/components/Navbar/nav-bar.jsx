                                ...
                                return (
                                    <>
                                        <li className="hoverable py-2">
                                            ...
                                            >
                                                <button
                                                    className="flex justify-between items-center font-medium text-gray-700 border-b border-gray-100 md:w-auto md:hover:bg-transparent md:border-0 md:p-0">
                                                    Company{" "}
                                                    <svg
                                            ...
                                            >
                                                <div
                                                    className="grid bg-blue-100  py-5 px-4 mx-auto max-w-screen-xl text-sm text-gray-500 dark:text-gray-400 md:grid-cols-3 md:px-6">
                                                    <ul
                                                    ...
                                                    <div
                                                        ...
                                                        >
                                                            Explore our brands
                                                            <span
                                                                className="sr-only">Explore our brands </span>
                                                            <svg
                                                                className="ml-1 w-4 h-4"
                                                                aria-hidden="true"
                                                                fill="currentColor"
