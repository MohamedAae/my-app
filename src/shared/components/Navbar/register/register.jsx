...
const Register = (props) => {
  ...
  return (
    <div>
      ...
      {showModal ? (
        <>
          <div className="z-50 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-0 rounded-lg shadow-lg flex flex-col bg-white outline-none focus:outline-none px-24 pb-12 pt-7">
            <div>
              <a href="/">
                <svg
                    width="260"
