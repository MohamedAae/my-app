                                ...
                                return (<div
                                    ...
                                    <div>
                                        ...
                                        {isAdmin ? <div
                                            ...
                                            <NavLink
                                                to={`/dashboard/edit-product/${book._id}`}
                                                className={`flex justify-center items-center capitalize bg-theme hover:bg-theme-hover text-background rounded-sm py-1`}>
                                                <PencilAltIcon width={15}
                                                               height={15}></PencilAltIcon>
                                                edit
                                            </NavLink>
                                            <span
