...
function Footer() {
  return (
    <footer class="bg-white dark:bg-gray-900">
      <hr className="my-10 border h-0.5 mx-6" />
      <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-6">
        <div>
        ...
        <form class="w-full max-w-sm col-span-2">
          <p className="text-sm text-gray-700">FIND A STORE</p>
          ...
          <p className="text-sm text-gray-700 mt-10 mb-2">
