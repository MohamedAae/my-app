...
const sortOptions = [
  ...
  { name: 'Best Rating', filter: "rating", direction: -1, href: '#', current: false },
  { name: 'Price: Low to High', filter: "price", direction: 1, href: '#', current: false },
  { name: 'Price: High to Low', filter: "price", direction: -1, href: '#', current: false },
]
...
const Grid = (props) => {
  ...
  const checkIfChecked = (event, id) => {
    ...
    return setCategoryId(categoryId.filter(
        (currentId) => {
          return currentId !== id;
        })
    );
          ...
          <div>
                            ...
                            {({open}) => (
                                <>
                                  <h3 className="-mx-2 -my-3 flow-root">
                                    ...
                                    <span
                                        className="font-medium text-gray-900">{filter.name}</span>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="relative z-10 flex items-baseline justify-between pt-14 pb-6 border-b border-gray-200">
                <h1 className="text-4xl font-extrabold tracking-tight text-background">Shop Book</h1>
              ...
              <section aria-labelledby="products-heading" className="pt-6 pb-24">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
                  ...
                  <form className="hidden lg:block">
                    ...
                    <ul role="list" className="text-sm font-medium text-gray-900 space-y-4 pb-6 border-b border-gray-200">
                      {discountRates.map((rate) => (
                          <li
                              ...
                              className={
                                rate.discount == discountRate ? "text-theme-hover" : "text-gray-400"
                              }
                          >
                    ...
                    {
                      <Disclosure as="div" key={filters.id} className="border-b border-gray-200 py-6">
                        {({ open }) => (
                            <>
