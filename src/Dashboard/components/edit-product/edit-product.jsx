...
const EditProduct = (props) => {
    ...
    const deleteProduct = async (productId) => {
        try {
            const res = await axios.delete(`http://127.0.0.1/products/${productId}`);
            console.log(res);
        } catch (e) {
            throw new Error(e);
        }
                ...
                <div className="md:grid md:grid-cols-3 md:gap-6">
                    ...
                    <div className="mt-5 md:mt-0 md:col-span-2">
                      ...
                      />
                                    ...
                                    <div>
                                        <label
                                            className="block text-sm font-medium text-gray-700">Photo</label>
                        ...
                        <svg className="h-full w-full text-gray-300"
                          ...
                          <path
                              d="M24 20.993V24H0v-2.996A14.977 14.977 0 0112.004 15c4.904 0 9.26 2.354 11.996 5.993zM16.002 8.999a4 4 0 11-8 0 4 4 0 018 0z"/>
                                    ...
                                    <div>
                                        <label
                                            className="block text-sm font-medium text-gray-700">Cover
                                            photo</label>
                                        <div
                    ...
                    <div className="md:col-span-1">
                        <div className="px-4 sm:px-0">
                            <h3 className="text-lg font-medium leading-6 text-gray-900">Personal
                                Information</h3>
                            <p className="mt-1 text-sm text-gray-600">Use a
                                permanent address where you can receive
                                mail.</p>
                        </div>
                    </div>
                    <div className="mt-5 md:mt-0 md:col-span-2">
                ...
                <div className="md:grid md:grid-cols-3 md:gap-6">
                    <div className="md:col-span-1">
                        <div className="px-4 sm:px-0">
                            ...
                            <p className="mt-1 text-sm text-gray-600">Decide
                                which communications you'd like to receive and
                                how.</p>
                        </div>
                    </div>
                    <div className="mt-5 md:mt-0 md:col-span-2">
                        <form action="#" method="POST">
                            <div
                                ...
                                <div
                                    className="px-4 py-5 bg-white space-y-6 sm:p-6">
                                    <fieldset>
                                        <legend className="sr-only">By Email
                                        </legend>
                                        <div
                                    ...
                                    <fieldset>
                                        <legend
                                            className="contents text-base font-medium text-gray-900">Push
                                            Notifications
                                        </legend>
