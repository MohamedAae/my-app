  ...
  const onSubmitHandler = async (id, product) => {
    ...
    try {
      const res = await axios.patch(
        `http://127.0.0.1:5003/products/${id}`,
        product
      );
      console.log(res);
    } catch (e) {
      ...
      <div>
        <div className="md:grid md:grid-cols-3 md:gap-6">
          ...
          <div className="mt-5 md:mt-0 md:col-span-2">
            <form onSubmit={() => onSubmitHandler(product._id, product)}>
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <textarea
                        ...
                        defaultValue={
                          Object.keys(product).length && product.description
                        }
                      />
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-6 gap-6">
                      ...
                      <div className="col-span-6 sm:col-span-3">
                        ...
                        <input
                          ...
                          className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                          value={
                            Object.keys(product).length && product.discountrate
                          }
                        />
                      </div>
                      ...
                      <div className="col-span-6 sm:col-span-3">
                        ...
                        >
                          {categories.length && Object.keys(product).length
