...
const WelcomeBanner = (props) => {
    return (<div
            ...
            <div className="relative">
                <h1 className="text-2xl md:text-3xl text-slate-800 font-bold mb-1 capitalize">Good
                    afternoon, {props.userName}. 👋</h1>
                <p className={`font-semibold opacity-50`}>Here is what’s
                    happening today.</p>
            </div>
